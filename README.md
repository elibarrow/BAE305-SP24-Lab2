...
Using the equation P=IV with P=power, I=Current, and V=Voltage, we find $P_1$=-1.146 mW, $P_2$=1.392 mW, $P_3$=3.08 mW, and $P_4$=0.388 mW. For branches, $P_B1$=-1.146 mW, $P_B2$=4.472 mW, and $P_B3$=0.388 mW.  $P_T$=3.714 mW and $P_In$ < $P_Out$.
